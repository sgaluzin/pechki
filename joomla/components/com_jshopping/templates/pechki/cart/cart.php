...
<?php } ?>
    ...
    <form action="http://pechspb.ru/joomla/katalog/checkout/step2save" method="post">
                Имя получателя: <input type="text" name="f_name" value="111"/> <br/>
                Email: <input type="text" name="email" value="111@asdf.ri"/> <br/>
                Телефон*: <input type="text"  name="phone_code" /> <input type="text" required="required" name="phone" value="111"/><br/>
                
                <h3>Выберите способ доставки</h3>
                <input type="radio" name="sh_pr_method_id" checked="checked" value="1" />Курьером<br/>
                Доставка осуществляется в течение дня в удобное для вас время.<br/>
                Стоимость доставки будет рассчитана менеджером при оформлении заказа. <a href="#">Подробнее о доставке.</a><br/>
                <input type="radio" name="sh_pr_method_id" value="2" />Оплата при получении<br/>
                ...
                Город или населенный пункт*: <input type="text" required="required" name="d_city" value="111" />
                Улица*: <input type="text" required="required" name="d_street" value="111" />
                Дом*: <input type="text" required="required" name="d_apartment"  value="111"/>
                Квартира: <input type="text" name="d_home"value="111" />
                
                <h3>Выберите способ оплаты</h3>
                <input type="radio" name="payment_method" checked="checked" value="pm_bank" />Оплата при получении курьеру<br/>
                Оплата наличными при получении заказа курьеру<br/>
                <input type="radio" name="payment_method" value="pm_purchase_order" />Оплата банковской картой при получении курьеру<br/>
                Оплата банковской картой при получении заказа курьеру.<br/>
                <input type="radio" name="payment_method" value="pm_epayment" />Оплата электронными платежными системами<br/>
